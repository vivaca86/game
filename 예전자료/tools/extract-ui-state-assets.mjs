...
const targets = [
  ...
  {
    key: "ui_current_stage_late_frame_concept",
    kind: "current_stage_frame",
    source: path.join(rootDir, "assets", "concepts", "ui", "world_map_ui_concept_v001.png"),
    output: path.join(rootDir, "assets", "source", "ui", "ui_current_stage_late_frame_concept_v001.png"),
    crop: { x: 940, y: 532, w: 170, h: 176 },
    nativeSize: { w: 210, h: 216 },
    stateVariant: "currentLate"
  },
  {
  ...
  {
    key: "ui_current_stage_late_body_wash_concept",
    kind: "world_map_stage_body_wash",
    source: path.join(rootDir, "assets", "concepts", "ui", "world_map_ui_concept_v001.png"),
    output: path.join(rootDir, "assets", "source", "ui", "ui_current_stage_late_body_wash_concept_v001.png"),
    crop: { x: 940, y: 532, w: 170, h: 176 },
    nativeSize: { w: 210, h: 216 },
    stateVariant: "currentLate"
  },
  ...
  {
    key: "ui_locked_stage_boss_frame_concept",
    kind: "locked_stage_frame",
    source: path.join(rootDir, "assets", "concepts", "ui", "world_map_ui_concept_v001.png"),
    output: path.join(rootDir, "assets", "source", "ui", "ui_locked_stage_boss_frame_concept_v001.png"),
    crop: { x: 1000, y: 190, w: 250, h: 250 },
    nativeSize: { w: 250, h: 250 },
    stateVariant: "lockedBoss"
  },
  {
  ...
  {
    key: "ui_locked_stage_boss_body_wash_concept",
    kind: "world_map_stage_body_wash",
    source: path.join(rootDir, "assets", "concepts", "ui", "world_map_ui_concept_v001.png"),
    output: path.join(rootDir, "assets", "source", "ui", "ui_locked_stage_boss_body_wash_concept_v001.png"),
    crop: { x: 1000, y: 190, w: 250, h: 250 },
    nativeSize: { w: 250, h: 250 },
    stateVariant: "lockedBoss"
  },
  ...
  {
    key: "ui_sealed_stage_mid_frame_concept",
    kind: "sealed_stage_frame",
    source: path.join(rootDir, "assets", "concepts", "ui", "world_map_ui_concept_v001.png"),
    output: path.join(rootDir, "assets", "source", "ui", "ui_sealed_stage_mid_frame_concept_v001.png"),
    crop: { x: 564, y: 356, w: 170, h: 178 },
    nativeSize: { w: 210, h: 220 },
    stateVariant: "sealedMid"
  },
  {
  ...
  {
    key: "ui_sealed_stage_mid_body_wash_concept",
    kind: "world_map_stage_body_wash",
    source: path.join(rootDir, "assets", "concepts", "ui", "world_map_ui_concept_v001.png"),
    output: path.join(rootDir, "assets", "source", "ui", "ui_sealed_stage_mid_body_wash_concept_v001.png"),
    crop: { x: 564, y: 356, w: 170, h: 178 },
    nativeSize: { w: 210, h: 220 },
    stateVariant: "sealedMid"
  },
  ...
  {
    key: "ui_dormant_stage_mid_frame_concept",
    kind: "sealed_stage_frame",
    source: path.join(rootDir, "assets", "concepts", "ui", "world_map_ui_concept_v001.png"),
    output: path.join(rootDir, "assets", "source", "ui", "ui_dormant_stage_mid_frame_concept_v001.png"),
    crop: { x: 564, y: 356, w: 170, h: 178 },
    nativeSize: { w: 210, h: 220 },
    stateVariant: "dormantMid"
  },
  {
  ...
  {
    key: "ui_dormant_stage_mid_body_wash_concept",
    kind: "world_map_stage_body_wash",
    source: path.join(rootDir, "assets", "concepts", "ui", "world_map_ui_concept_v001.png"),
    output: path.join(rootDir, "assets", "source", "ui", "ui_dormant_stage_mid_body_wash_concept_v001.png"),
    crop: { x: 564, y: 356, w: 170, h: 178 },
    nativeSize: { w: 210, h: 220 },
    stateVariant: "dormantMid"
  },
  ...
  {
    key: "ui_world_map_lower_node_frame_concept",
    kind: "world_map_lower_node_frame",
    source: path.join(rootDir, "assets", "concepts", "ui", "world_map_ui_concept_v001.png"),
    output: path.join(rootDir, "assets", "source", "ui", "ui_world_map_lower_node_frame_concept_v001.png"),
    crop: { x: 622, y: 586, w: 170, h: 178 },
    nativeSize: { w: 210, h: 220 }
  },
  {
...
try {
  ...
  for (const target of targets) {
    ...
    const dataUrl = target.kind === "world_map_neutral_underlay"
      ...
      : target.kind === "world_map_lower_node_frame"
      ? await page.evaluate(async ({ base64, crop, nativeSize }) => {
        const image = await new Promise((resolve, reject) => {
          const img = new Image();
          img.onload = () => resolve(img);
        ...
        const inner = [
          ...
          { x: nativeSize.w * 0.69, y: nativeSize.h * 0.5 },
          { x: nativeSize.w * 0.6, y: nativeSize.h * 0.63 },
          { x: nativeSize.w * 0.5, y: nativeSize.h * 0.71 },
          { x: nativeSize.w * 0.4, y: nativeSize.h * 0.63 },
          { x: nativeSize.w * 0.31, y: nativeSize.h * 0.5 },
        ...
        for (let y = 0; y < nativeSize.h; y += 1) {
          for (let x = 0; x < nativeSize.w; x += 1) {
            const offset = (y * nativeSize.w + x) * 4;
            const readX = x > centerX ? Math.max(0, Math.min(nativeSize.w - 1, Math.round(nativeSize.w - x - 1))) : x;
            const sourceOffset = (y * nativeSize.w + readX) * 4;
            ...
            const radial = Math.hypot((x - centerX) / (nativeSize.w * 0.43), (y - centerY) / (nativeSize.h * 0.45));
            const outerFalloff = 1 - smoothstep(0.76, 1.14, radial);
            const outerEdgeBand = 1 - smoothstep(8, 24, distanceToPolygonEdges(x, y, outer));
            const innerEdgeBand = 1 - smoothstep(6, 18, distanceToPolygonEdges(x, y, inner));
            const frameEdgeBand = Math.max(outerEdgeBand, innerEdgeBand * 0.76);
            const lowerBadgeCutout = y > nativeSize.h * 0.58 && x > nativeSize.w * 0.16 && x < nativeSize.w * 0.84 ? 0 : 1;
            const sideRouteCutout = (x < nativeSize.w * 0.18 || x > nativeSize.w * 0.78) && y > nativeSize.h * 0.36 ? 0 : 1;
            const lowerRouteCutout = y > nativeSize.h * 0.74 && (x < nativeSize.w * 0.34 || x > nativeSize.w * 0.66) ? 0 : 1;
            const rightArtifactCutout = 1 - smoothstep(0.58, 0.74, x / nativeSize.w) * smoothstep(0.38, 0.64, y / nativeSize.h);
            const gold = smoothstep(42, 146, r + g * 0.74 - b * 1.48 + saturation * 0.16);
            const paperEdge = smoothstep(62, 176, luminance) * (1 - smoothstep(70, 160, saturation));
            const darkEdge = (1 - smoothstep(50, 136, luminance)) * smoothstep(16, 108, saturation);
            let keep = Math.max(gold * 0.92, paperEdge * 0.42, darkEdge * 0.74)
              * outerMask
              * innerCutout
              * outerFalloff
              * frameEdgeBand
            ...
            const warmR = Math.min(255, 118 + luminance * 0.34 + gold * 34 + darkEdge * 18);
            const warmG = Math.min(255, 92 + luminance * 0.29 + gold * 26 + paperEdge * 8);
            const warmB = Math.min(255, 58 + luminance * 0.18 + paperEdge * 7);
            const sourceMix = 0.24;
            data[offset] = Math.round(r * sourceMix + warmR * (1 - sourceMix));
            data[offset + 1] = Math.round(g * sourceMix + warmG * (1 - sourceMix));
            data[offset + 2] = Math.round(b * sourceMix + warmB * (1 - sourceMix));
            data[offset + 3] = Math.round(Math.min(226, 218 * keep * (0.54 + outerFalloff * 0.42)));
          }
        }
        ...
        function distanceToPolygonEdges(x, y, polygon) {
          ...
          for (let i = 0, j = polygon.length - 1; i < polygon.length; j = i, i += 1) {
            distance = Math.min(distance, distanceToSegment(x, y, polygon[j].x, polygon[j].y, polygon[i].x, polygon[i].y));
          }
          return distance;
        }
      ...
      ? await page.evaluate(async ({ base64, crop, nativeSize, stateVariant }) => {
        ...
        const lateVariant = stateVariant === "currentLate";
        ...
        for (let y = 0; y < nativeSize.h; y += 1) {
          for (let x = 0; x < nativeSize.w; x += 1) {
            ...
            const colorKeep = lateVariant
              ? Math.max(cyan * 0.82, blue * 0.74, gold * 0.12, darkEdge * 0.08)
              : Math.max(cyan * 1.06, blue * 0.98, gold * 0.18);
            let keep = colorKeep * ring * statusCutout * markerCutout * routeCutout;
            if (parchment) keep = 0;
            ...
            if (lateVariant) {
              data[offset] = Math.min(255, Math.round(r * 0.96 + cyan * 3 + gold * 5));
              data[offset + 1] = Math.min(255, Math.round(g * 1.0 + cyan * 8 + gold * 3));
              data[offset + 2] = Math.min(255, Math.round(b * 1.02 + cyan * 11));
            } else {
            ...
            const alphaCap = lateVariant ? 204 : 232;
            data[offset + 3] = Math.round(Math.min(alphaCap, 238 * keep * (0.58 + outerFalloff * 0.48) * alphaScale));
          }
        }
      ...
      ? await page.evaluate(async ({ base64, crop, nativeSize, stateVariant }) => {
        ...
        const lockedBossVariant = stateVariant === "lockedBoss";
        ...
        for (let y = 0; y < nativeSize.h; y += 1) {
          for (let x = 0; x < nativeSize.w; x += 1) {
            ...
            const saturation = max - min;
            const luminance = r * 0.299 + g * 0.587 + b * 0.114;
            const outer = lockedBossVariant
              ? [
                { x: nativeSize.w * 0.5, y: nativeSize.h * 0.04 },
                { x: nativeSize.w * 0.67, y: nativeSize.h * 0.1 },
                { x: nativeSize.w * 0.89, y: nativeSize.h * 0.2 },
                { x: nativeSize.w * 0.96, y: nativeSize.h * 0.42 },
                { x: nativeSize.w * 0.78, y: nativeSize.h * 0.73 },
                { x: nativeSize.w * 0.5, y: nativeSize.h * 0.88 },
                { x: nativeSize.w * 0.22, y: nativeSize.h * 0.73 },
                { x: nativeSize.w * 0.04, y: nativeSize.h * 0.42 },
                { x: nativeSize.w * 0.11, y: nativeSize.h * 0.2 },
                { x: nativeSize.w * 0.33, y: nativeSize.h * 0.1 }
              ]
              : [
            ...
            const inner = lockedBossVariant
              ? [
                { x: nativeSize.w * 0.5, y: nativeSize.h * 0.25 },
                { x: nativeSize.w * 0.63, y: nativeSize.h * 0.34 },
                { x: nativeSize.w * 0.69, y: nativeSize.h * 0.49 },
                { x: nativeSize.w * 0.6, y: nativeSize.h * 0.64 },
                { x: nativeSize.w * 0.5, y: nativeSize.h * 0.72 },
                { x: nativeSize.w * 0.4, y: nativeSize.h * 0.64 },
                { x: nativeSize.w * 0.31, y: nativeSize.h * 0.49 },
                { x: nativeSize.w * 0.37, y: nativeSize.h * 0.34 }
              ]
              : [
                { x: nativeSize.w * 0.5, y: nativeSize.h * 0.22 },
            ...
            const colorKeep = lockedBossVariant
              ? Math.max(red * 0.66, gold * 0.26, darkEdge * 0.26)
              : lockedFarVariant
            ...
            let keep = colorKeep
              ...
              * lockCutout
              * routeCutout;
            if (lockedBossVariant && x < nativeSize.w * 0.2 && y < nativeSize.h * 0.24) keep = 0;
            ...
            if (lockedBossVariant) {
              data[offset] = Math.min(255, Math.round(r * 0.99 + red * 10 + gold * 8));
              data[offset + 1] = Math.min(255, Math.round(g * 0.95 + gold * 8));
            ...
            const alphaCap = lockedBossVariant ? 178 : lockedFarVariant ? 188 : 232;
            const alphaScale = lockedBossVariant ? 0.72 : lockedFarVariant ? 0.78 : 1;
            data[offset + 3] = Math.round(Math.min(alphaCap, 238 * keep * (0.58 + outerFalloff * 0.46) * alphaScale));
          }
        }
      ...
      ? await page.evaluate(async ({ base64, crop, nativeSize, stateVariant }) => {
        ...
        const sealedMidVariant = stateVariant === "sealedMid";
        ...
        for (let y = 0; y < nativeSize.h; y += 1) {
          for (let x = 0; x < nativeSize.w; x += 1) {
            ...
            const colorKeep = sealedMidVariant
              ? Math.max(silver * 0.86, coolEdge * 0.94, gold * 0.16, darkEdge * 0.18)
              : dormantMidVariant
              ? Math.max(silver * 0.78, coolEdge * 0.86, gold * 0.14, darkEdge * 0.18)
              : Math.max(silver * 0.96, coolEdge * 1.02, gold * 0.2, darkEdge * 0.22);
            let keep = colorKeep
              * outerMask
              * innerCutout
              * numberCutout
            ...
            if (sealedMidVariant) {
              ...
              data[offset + 1] = Math.min(255, Math.round(g * 1.0 + silver * 4));
              data[offset + 2] = Math.min(255, Math.round(b * 1.02 + coolEdge * 7));
            } else if (dormantMidVariant) {
              data[offset] = Math.min(255, Math.round(r * 0.96 + gold * 4));
              data[offset + 1] = Math.min(255, Math.round(g * 0.99 + silver * 3));
              data[offset + 2] = Math.min(255, Math.round(b * 1.01 + coolEdge * 6));
            } else {
              data[offset] = Math.min(255, Math.round(r * 0.98 + gold * 6));
              data[offset + 1] = Math.min(255, Math.round(g * 1.01 + silver * 5));
              data[offset + 2] = Math.min(255, Math.round(b * 1.03 + coolEdge * 9));
            }
            const alphaCap = sealedMidVariant ? 198 : dormantMidVariant ? 188 : 226;
            const alphaScale = sealedMidVariant ? 0.86 : dormantMidVariant ? 0.78 : 1;
            data[offset + 3] = Math.round(Math.min(alphaCap, 232 * keep * (0.56 + outerFalloff * 0.44) * alphaScale));
          }
        }
      ...
      ? await page.evaluate(async ({ base64, crop, nativeSize, stateVariant }) => {
        ...
        const lockedFarVariant = stateVariant === "lockedFar";
        const lockedBossVariant = stateVariant === "lockedBoss";
        const redLockedVariant = stateVariant === "locked" || lockedFarVariant || lockedBossVariant;
        const sealedMidVariant = stateVariant === "sealedMid";
        const grayLockedVariant = stateVariant === "sealed" || sealedMidVariant || stateVariant === "dormant" || stateVariant === "dormantMid";
        const completedLateVariant = stateVariant === "completedLate";
        const currentVariant = stateVariant === "current" || stateVariant === "currentLate";
        const currentLateVariant = stateVariant === "currentLate";
        const dormantMidVariant = stateVariant === "dormantMid";
        const subduedGrayMidVariant = sealedMidVariant || dormantMidVariant;
        const numberY = currentVariant
          ...
          : redLockedVariant
            ...
            : grayLockedVariant
              ? nativeSize.h * 0.35
              : nativeSize.h * 0.36;
        const numberRx = redLockedVariant ? nativeSize.w * (lockedBossVariant ? 0.29 : lockedFarVariant ? 0.32 : 0.31) : grayLockedVariant ? nativeSize.w * (subduedGrayMidVariant ? 0.29 : 0.27) : completedLateVariant ? nativeSize.w * 0.24 : currentLateVariant ? nativeSize.w * 0.23 : nativeSize.w * 0.21;
        const numberRy = redLockedVariant ? nativeSize.h * (lockedBossVariant ? 0.22 : lockedFarVariant ? 0.25 : 0.24) : grayLockedVariant ? nativeSize.h * (subduedGrayMidVariant ? 0.23 : 0.22) : completedLateVariant ? nativeSize.h * 0.19 : currentLateVariant ? nativeSize.h * 0.18 : nativeSize.h * 0.17;
        ...
        const lowerIconRx = currentVariant ? nativeSize.w * 0.18 : redLockedVariant ? nativeSize.w * (lockedBossVariant ? 0.34 : 0.38) : grayLockedVariant ? nativeSize.w * 0.32 : completedLateVariant ? nativeSize.w * 0.31 : nativeSize.w * 0.28;
        const lowerIconRy = redLockedVariant ? nativeSize.h * (lockedBossVariant ? 0.24 : 0.27) : grayLockedVariant ? nativeSize.h * 0.24 : completedLateVariant ? nativeSize.h * 0.22 : nativeSize.h * 0.2;
        ...
        for (let y = 0; y < nativeSize.h; y += 1) {
          for (let x = 0; x < nativeSize.w; x += 1) {
            ...
            const outer = lockedBossVariant
              ? [
                { x: nativeSize.w * 0.5, y: nativeSize.h * 0.06 },
                { x: nativeSize.w * 0.68, y: nativeSize.h * 0.12 },
                { x: nativeSize.w * 0.88, y: nativeSize.h * 0.23 },
                { x: nativeSize.w * 0.94, y: nativeSize.h * 0.48 },
                { x: nativeSize.w * 0.75, y: nativeSize.h * 0.76 },
                { x: nativeSize.w * 0.5, y: nativeSize.h * 0.89 },
                { x: nativeSize.w * 0.25, y: nativeSize.h * 0.76 },
                { x: nativeSize.w * 0.06, y: nativeSize.h * 0.48 },
                { x: nativeSize.w * 0.12, y: nativeSize.h * 0.23 },
                { x: nativeSize.w * 0.32, y: nativeSize.h * 0.12 }
              ]
              : [
                { x: nativeSize.w * 0.5, y: nativeSize.h * 0.09 },
                { x: nativeSize.w * 0.76, y: nativeSize.h * 0.22 },
            ...
            const currentMarkerCutout = currentVariant
              ? smoothstep(
                0.78,
                1.04,
            ...
            const rightStatusRouteCutout = currentVariant && x > nativeSize.w * 0.7 && y > nativeSize.h * 0.42 && y < nativeSize.h * 0.68 ? 0 : 1;
            ...
            } else if (currentLateVariant) {
              colorKeep = Math.max(cyan * 0.82, blue * 0.76, gold * 0.16, darkEdge * 0.12);
            ...
            } else if (sealedMidVariant) {
              colorKeep = Math.max(silver * 0.88, coolEdge * 0.96, gold * 0.16, darkEdge * 0.18);
            } else if (dormantMidVariant) {
            ...
            } else if (lockedBossVariant) {
              colorKeep = Math.max(red * 0.68, gold * 0.24, darkEdge * 0.18);
            } else if (lockedFarVariant) {
            ...
            if (stateVariant === "current") {
              ...
              data[offset] = Math.min(255, Math.round(r * 0.96 + cyan * 4 + gold * 5));
              data[offset + 1] = Math.min(255, Math.round(g * 1.0 + cyan * 8 + gold * 3));
              data[offset + 2] = Math.min(255, Math.round(b * 1.02 + cyan * 11));
            } else if (stateVariant === "completed") {
              ...
              data[offset] = Math.min(255, Math.round(r * 0.98 + red * 10 + gold * 7));
              data[offset + 1] = Math.min(255, Math.round(g * 0.94 + gold * 7));
              data[offset + 2] = Math.max(0, Math.round(b * 0.86));
            } else if (lockedFarVariant) {
              data[offset] = Math.min(255, Math.round(r * 0.98 + red * 12 + gold * 5));
              data[offset + 1] = Math.min(255, Math.round(g * 0.94 + gold * 6));
            ...
            const alphaScale = completedLateVariant || currentLateVariant || sealedMidVariant || dormantMidVariant || lockedFarVariant || lockedBossVariant ? 0.78 : 1;
            const alphaCap = completedLateVariant ? 178 : currentLateVariant ? 184 : sealedMidVariant ? 186 : dormantMidVariant ? 176 : lockedBossVariant ? 168 : lockedFarVariant ? 180 : 216;
