...
const sourcePassthroughAssets = new Map([
  ...
  ["ui_hover_settings_reset_save_concept", path.join(rootDir, "assets", "source", "ui", "ui_hover_settings_reset_save_concept_v001.png")],
  ["ui_down_settings_reset_save_concept", path.join(rootDir, "assets", "source", "ui", "ui_down_settings_reset_save_concept_v001.png")],
  ["ui_hover_settings_reset_defaults_concept", path.join(rootDir, "assets", "source", "ui", "ui_hover_settings_reset_defaults_concept_v001.png")],
  ["ui_down_settings_reset_defaults_concept", path.join(rootDir, "assets", "source", "ui", "ui_down_settings_reset_defaults_concept_v001.png")],
  ["ui_hover_settings_volume_master_concept", path.join(rootDir, "assets", "source", "ui", "ui_hover_settings_volume_master_concept_v001.png")],
  ["ui_down_settings_volume_master_concept", path.join(rootDir, "assets", "source", "ui", "ui_down_settings_volume_master_concept_v001.png")],
  ["ui_hover_settings_volume_music_concept", path.join(rootDir, "assets", "source", "ui", "ui_hover_settings_volume_music_concept_v001.png")],
  ["ui_down_settings_volume_music_concept", path.join(rootDir, "assets", "source", "ui", "ui_down_settings_volume_music_concept_v001.png")],
  ["ui_hover_settings_volume_sfx_concept", path.join(rootDir, "assets", "source", "ui", "ui_hover_settings_volume_sfx_concept_v001.png")],
  ["ui_down_settings_volume_sfx_concept", path.join(rootDir, "assets", "source", "ui", "ui_down_settings_volume_sfx_concept_v001.png")],
  ["ui_hover_settings_display_mode_concept", path.join(rootDir, "assets", "source", "ui", "ui_hover_settings_display_mode_concept_v001.png")],
  ["ui_down_settings_display_mode_concept", path.join(rootDir, "assets", "source", "ui", "ui_down_settings_display_mode_concept_v001.png")],
  ["ui_hover_settings_large_text_concept", path.join(rootDir, "assets", "source", "ui", "ui_hover_settings_large_text_concept_v001.png")],
  ["ui_down_settings_large_text_concept", path.join(rootDir, "assets", "source", "ui", "ui_down_settings_large_text_concept_v001.png")],
  ["ui_hover_settings_reduced_motion_concept", path.join(rootDir, "assets", "source", "ui", "ui_hover_settings_reduced_motion_concept_v001.png")],
  ["ui_down_settings_reduced_motion_concept", path.join(rootDir, "assets", "source", "ui", "ui_down_settings_reduced_motion_concept_v001.png")],
  ["ui_hover_settings_space_confirm_concept", path.join(rootDir, "assets", "source", "ui", "ui_hover_settings_space_confirm_concept_v001.png")],
  ["ui_down_settings_space_confirm_concept", path.join(rootDir, "assets", "source", "ui", "ui_down_settings_space_confirm_concept_v001.png")],
  ["ui_hover_town_expedition_action_concept", path.join(rootDir, "assets", "source", "ui", "ui_hover_town_expedition_action_concept_v001.png")],
  ["ui_down_town_expedition_action_concept", path.join(rootDir, "assets", "source", "ui", "ui_down_town_expedition_action_concept_v001.png")],
  ["ui_hover_town_toolbar_reset_concept", path.join(rootDir, "assets", "source", "ui", "ui_hover_town_toolbar_reset_concept_v001.png")],
  ["ui_down_town_toolbar_reset_concept", path.join(rootDir, "assets", "source", "ui", "ui_down_town_toolbar_reset_concept_v001.png")],
  ["ui_hover_town_toolbar_settings_concept", path.join(rootDir, "assets", "source", "ui", "ui_hover_town_toolbar_settings_concept_v001.png")],
  ["ui_down_town_toolbar_settings_concept", path.join(rootDir, "assets", "source", "ui", "ui_down_town_toolbar_settings_concept_v001.png")],
  ["ui_hover_runebench_action_rail_concept", path.join(rootDir, "assets", "source", "ui", "ui_hover_runebench_action_rail_concept_v001.png")],
  ["ui_down_runebench_action_rail_concept", path.join(rootDir, "assets", "source", "ui", "ui_down_runebench_action_rail_concept_v001.png")],
  ["ui_hover_runebench_confirm_button_concept", path.join(rootDir, "assets", "source", "ui", "ui_hover_runebench_confirm_button_concept_v001.png")],
  ["ui_down_runebench_confirm_button_concept", path.join(rootDir, "assets", "source", "ui", "ui_down_runebench_confirm_button_concept_v001.png")],
  ["ui_hover_result_action_card_concept", path.join(rootDir, "assets", "source", "ui", "ui_hover_result_action_card_concept_v001.png")],
  ["ui_down_result_action_card_concept", path.join(rootDir, "assets", "source", "ui", "ui_down_result_action_card_concept_v001.png")],
  ...
  ["ui_current_stage_late_frame_concept", path.join(rootDir, "assets", "source", "ui", "ui_current_stage_late_frame_concept_v001.png")],
  ...
  ["ui_world_map_lower_node_body_concept", path.join(rootDir, "assets", "source", "ui", "ui_world_map_lower_node_body_concept_v001.png")],
  ["ui_world_map_lower_node_frame_concept", path.join(rootDir, "assets", "source", "ui", "ui_world_map_lower_node_frame_concept_v001.png")],
  ["ui_completed_stage_body_wash_concept", path.join(rootDir, "assets", "source", "ui", "ui_completed_stage_body_wash_concept_v001.png")],
  ["ui_completed_stage_late_body_wash_concept", path.join(rootDir, "assets", "source", "ui", "ui_completed_stage_late_body_wash_concept_v001.png")],
  ["ui_completed_stage_frame_concept", path.join(rootDir, "assets", "source", "ui", "ui_completed_stage_frame_concept_v001.png")],
  ["ui_completed_stage_late_frame_concept", path.join(rootDir, "assets", "source", "ui", "ui_completed_stage_late_frame_concept_v001.png")],
  ...
  ["ui_locked_stage_far_body_wash_concept", path.join(rootDir, "assets", "source", "ui", "ui_locked_stage_far_body_wash_concept_v001.png")],
  ["ui_locked_stage_boss_body_wash_concept", path.join(rootDir, "assets", "source", "ui", "ui_locked_stage_boss_body_wash_concept_v001.png")],
  ["ui_locked_stage_frame_concept", path.join(rootDir, "assets", "source", "ui", "ui_locked_stage_frame_concept_v001.png")],
  ["ui_locked_stage_far_frame_concept", path.join(rootDir, "assets", "source", "ui", "ui_locked_stage_far_frame_concept_v001.png")],
  ["ui_locked_stage_boss_frame_concept", path.join(rootDir, "assets", "source", "ui", "ui_locked_stage_boss_frame_concept_v001.png")],
  ["ui_locked_stage_badge_concept", path.join(rootDir, "assets", "source", "ui", "ui_locked_stage_badge_concept_v001.png")],
  ["ui_sealed_stage_body_wash_concept", path.join(rootDir, "assets", "source", "ui", "ui_sealed_stage_body_wash_concept_v001.png")],
  ["ui_sealed_stage_mid_body_wash_concept", path.join(rootDir, "assets", "source", "ui", "ui_sealed_stage_mid_body_wash_concept_v001.png")],
  ["ui_sealed_stage_frame_concept", path.join(rootDir, "assets", "source", "ui", "ui_sealed_stage_frame_concept_v001.png")],
  ["ui_sealed_stage_mid_frame_concept", path.join(rootDir, "assets", "source", "ui", "ui_sealed_stage_mid_frame_concept_v001.png")],
  ["ui_sealed_stage_badge_concept", path.join(rootDir, "assets", "source", "ui", "ui_sealed_stage_badge_concept_v001.png")],
  ["ui_dormant_stage_body_wash_concept", path.join(rootDir, "assets", "source", "ui", "ui_dormant_stage_body_wash_concept_v001.png")],
  ["ui_dormant_stage_mid_body_wash_concept", path.join(rootDir, "assets", "source", "ui", "ui_dormant_stage_mid_body_wash_concept_v001.png")],
  ["ui_dormant_stage_frame_concept", path.join(rootDir, "assets", "source", "ui", "ui_dormant_stage_frame_concept_v001.png")],
  ["ui_dormant_stage_mid_frame_concept", path.join(rootDir, "assets", "source", "ui", "ui_dormant_stage_mid_frame_concept_v001.png")],
  ["ui_world_map_route_progress_thread_concept", path.join(rootDir, "assets", "source", "ui", "ui_world_map_route_progress_thread_concept_v001.png")],
  ["ui_world_map_route_progress_current_thread_concept", path.join(rootDir, "assets", "source", "ui", "ui_world_map_route_progress_current_thread_concept_v001.png")],
  ["ui_world_map_route_locked_thread_concept", path.join(rootDir, "assets", "source", "ui", "ui_world_map_route_locked_thread_concept_v001.png")],
  ["ui_world_map_route_progress_bead_concept", path.join(rootDir, "assets", "source", "ui", "ui_world_map_route_progress_bead_concept_v001.png")],
  ["ui_world_map_route_progress_current_bead_concept", path.join(rootDir, "assets", "source", "ui", "ui_world_map_route_progress_current_bead_concept_v001.png")],
  ["ui_world_map_route_locked_bead_concept", path.join(rootDir, "assets", "source", "ui", "ui_world_map_route_locked_bead_concept_v001.png")],
