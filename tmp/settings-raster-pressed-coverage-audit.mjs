...
const targets = [
  { label: "volume-master", x: 840, y: 282, downKey: "ui_down_settings_volume_master_concept" },
  { label: "volume-music", x: 840, y: 372, downKey: "ui_down_settings_volume_music_concept" },
  { label: "volume-sfx", x: 840, y: 462, downKey: "ui_down_settings_volume_sfx_concept" },
  { label: "display-mode", x: 1360, y: 282, downKey: "ui_down_settings_display_mode_concept" },
  { label: "large-text", x: 1360, y: 372, downKey: "ui_down_settings_large_text_concept" },
  { label: "reduced-motion", x: 1360, y: 462, downKey: "ui_down_settings_reduced_motion_concept" },
  { label: "space-confirm", x: 1360, y: 640, downKey: "ui_down_settings_space_confirm_concept" },
  { label: "reset-save", x: 1626, y: 520, downKey: "ui_down_settings_reset_save_concept" },
  { label: "reset-defaults", x: 1626, y: 696, downKey: "ui_down_settings_reset_defaults_concept" },
