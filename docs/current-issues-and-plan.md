...
- A later 2026-06-14 WorldMap keyboard-selection tooltip pass connects direction-key stage selection to the same DOM readability tooltip layer without turning on an extra hover image. `tools/ui-worldmap-keyboard-tooltip-audit.mjs` verifies lower-left and late-right selection paths across 1920x1080, 1280x720, and 390x844, including one current halo only, no visible Phaser text/vector leak, and safe desktop/mobile placement. Open-stage WorldMap tooltip bodies now include status and room count, so very short stage descriptions are no longer the only readable text.
...
3. Refine selected/focus/keyboard state art without falling back to Phaser vector overlays. WorldMap directional keyboard selection now also has visible tooltip evidence, and Town/Reward/Event/Dungeon/RuneBench/Result keyboard-confirm feedback, Dungeon directional focus, Reward/Event directional choice focus, Town/RuneBench/Result utility focus, Combat/Boss keyboard card/end-turn feedback plus directional focus, Settings keyboard-cancel plus keyboard-focus feedback, and representative focus-triggered DOM tooltip evidence now exist, but this is not final keyboard/focus coverage across screens.
...
- Selected/focus/keyboard state art beyond the first WorldMap directional-selection plus selected-stage tooltip pass, Town/Reward/Event/Dungeon/RuneBench/Result keyboard-confirm feedback pass, Dungeon directional focus pass, Reward/Event directional choice-focus pass, Town/RuneBench/Result utility-focus pass, Combat/Boss keyboard-action plus directional focus pass, Settings keyboard-cancel/focus feedback pass, and representative focus-triggered tooltip audit.
