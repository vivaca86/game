"""REJECTED EXPERIMENT ONLY; do not promote this output to runtime art.

The v3 pot-bongo concept was rejected by the user as thematically abrupt.
This script remains only to preserve the alpha-processing audit trail described
in assets/taskbar-cat-v3/STATUS.md and docs/recovery-audit.md.
...
ASSET_DIR = ROOT / "assets" / "taskbar-cat-v3"
SOURCE_CHROMA = ASSET_DIR / "taskbar-cat-v3-chroma-atlas.png"
SOURCE_HELPER = ASSET_DIR / "taskbar-cat-v3-alpha-helper.png"
OUTPUT = ASSET_DIR / "taskbar-cat-v3-alpha-unregistered.png"

EXPECTED_PILLOW_VERSION = "12.3.0"
EXPECTED_CHROMA_SHA256 = "13f1ab2c26a45df535faaed4adf1c8b2f8945adc9c4e79e86ceb5233d71bf297"
EXPECTED_HELPER_SHA256 = "7cc8969fec3a85f4dd650d66999653d4be1004e3af63ce80b950b1803900b489"
EDGE_RADIUS = 2
